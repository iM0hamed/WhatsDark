...
@class WABaseReceiptTableViewCell; @class WAMediaGalleryViewController; @class WAContactPropertyTextField; @class UITableViewController; @class WABadgedLabel; @class WADateBubbleView; @class WASettingsProfileTableViewCell; @class UITableViewHeaderFooterView; @class FRFavoriteTableViewCell; @class WAAutoscrollingLabel; @class UITabBar; @class WAReceiptTableViewCell; @class UINavigationController; @class _WADraggableInputContainerView; @class WASettingsViewController; @class WALabel; @class WAStatusTextView; @class UITableView; @class WAContactTableViewCell; @class UITextView; @class WAContactCardItemTableViewCell; @class WAMediaBrowserCollectionView; @class STUpdateTableViewCell; @class WAAdjustableSeparatorTableViewCell; @class WAWebClientSessionTableViewCell; @class WAProfilePictureScrollView; @class STUpdateHeaderView; @class WABackupInfoTableCell; @class WACallHistoryTableViewCell; @class WAStatusScrollView; 
