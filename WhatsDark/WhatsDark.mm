...
@class UITableViewController; @class WAAdjustableSeparatorTableViewCell; @class UITabBar; @class WABadgedLabel; @class WALabel; @class UITableView; @class WAContactCardItemTableViewCell; @class WACallHistoryTableViewCell; @class WAMediaBrowserCollectionView; @class WABackupInfoTableCell; @class FRFavoriteTableViewCell; @class STUpdateHeaderView; @class WAStatusTextView; @class WASettingsViewController; @class WAContactPropertyTextField; @class WAAutoscrollingLabel; @class STUpdateTableViewCell; @class WAWebClientSessionTableViewCell; @class WASettingsProfileTableViewCell; @class WAProfilePictureScrollView; @class WAMediaGalleryViewController; @class WADateBubbleView; @class UINavigationController; @class _WADraggableInputContainerView; @class WAContactTableViewCell; @class WAStatusScrollView; @class WAReceiptTableViewCell; @class WABaseReceiptTableViewCell; @class UITextView; @class UITableViewHeaderFooterView; 
